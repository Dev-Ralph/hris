...
<head>
  ...
  <body>
    <div class="sidenav text-center">
      ...
      <br>Home</a>
      <a href="inbox.php" class="sidenav-margin-y home-active"><i class="fa fa-inbox sidenav-icon sidenav-icon-home-active" aria-hidden="true"></i>
      <br>Inbox</a>
